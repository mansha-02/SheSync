  ...
  return (
    <div className="flex h-screen bg-pink-50 dark:bg-gray-950 overflow-hidden">
      ...
      <button
        ...
        className="fixed left-0 top-0 w-10 z-50 p-2 bg-pink-600 text-white rounded-r-md transition-all duration-300 ease-in-out"
        style={{
      ...
      >
        <ChevronRight
          size={14}
          className={`transition-transform block m-auto ${
